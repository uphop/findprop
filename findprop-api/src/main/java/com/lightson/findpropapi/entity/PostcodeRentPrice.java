...
@Entity
@Table(name = "postcode_rent_price")
public class PostcodeRentPrice {
    ...
    public PostcodeRentPrice(Long id, String propertyType, Integer bedrooms, Integer priceCount, Integer priceMean,
            Integer priceLow, Integer priceMedian, Integer priceHigh, String currency, String period, String source,
            Date published, Date recordedFrom, Date recordedTo, Postcode postcode) {
        this.id = id;
    ...
    public void setPostcodeArea(Postcode postcode) {
        this.postcode = postcode;
    }
    ...
    public String toString() {
        return "PostcodeAreaRentPrice [bedrooms=" + bedrooms + ", currency=" + currency + ", id=" + id + ", period="
                + period + ", postcode=" + postcode + ", priceCount=" + priceCount + ", priceHigh=" + priceHigh
