...
@Entity
@Table(name = "region_rent_price")
public class RegionRentPrice implements Serializable {
    @Id
    ...
    public RegionRentPrice(Long id, String propertyType, Integer bedrooms, Integer priceCount, Integer priceMean,
            Integer priceLow, Integer priceMedian, Integer priceHigh, String currency, String period, String source,
            Date published, Date recordedFrom, Date recordedTo, Region region) {
        this.id = id;
    ...
    public String toString() {
        return "RegionRentPrice [bedrooms=" + bedrooms + ", currency=" + currency + ", id=" + id + ", period=" + period
                ...
                + published + ", recordedFrom=" + recordedFrom + ", recordedTo=" + recordedTo + ", region=" + region
                + ", source=" + source + "]";
    }
}
