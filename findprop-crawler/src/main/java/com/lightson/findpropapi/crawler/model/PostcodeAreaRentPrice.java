...
public class PostcodeAreaRentPrice {
    ...
    public PostcodeAreaRentPrice(PropertyTypeEnum property_type, Integer bedrooms, Integer price_count, Integer price_mean,
            Integer price_low, Integer price_median, Integer price_high, CurrencyEnum currency, PeriodEnum period, String source,
    ...
    public String toString() {
        return "TargetRentPrice [bedrooms=" + bedrooms + ", currency=" + currency + ", period=" + period
