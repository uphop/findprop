...
public class TargetLocalAuthorityRentPrice {
    ...
    public TargetLocalAuthorityRentPrice(String property_type, Integer bedrooms, Integer price_count, Integer price_mean,
            Integer price_low, Integer price_median, Integer price_high, String currency, String period, String source,
            String published, String recorded_from, String recorded_to, String local_authority) {
    ...
    public TargetLocalAuthorityRentPrice() {
    }
    ...
    public String toString() {
        return "TargetLocalAuthorityRentPrice [bedrooms=" + bedrooms + ", currency=" + currency + ", period=" + period
                ...
                + ", local_authority=" + local_authority + ", source=" + source + "]";
    }
