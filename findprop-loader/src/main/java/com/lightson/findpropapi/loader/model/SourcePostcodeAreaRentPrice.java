...
public class SourcePostcodeAreaRentPrice {
    ...
    public SourcePostcodeAreaRentPrice(String postcodeArea, String bedroomCategory, Integer countOfRents, Integer mean,
    ...
    public SourcePostcodeAreaRentPrice() {
    }
    ...
    public String toString() {
        return "SourcePostcodeAreaRentPrice [bedroomCategory=" + bedroomCategory + ", countOfRents=" + countOfRents
