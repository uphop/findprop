...
public class TargetPostcodeRentPrice {
    ...
    public TargetPostcodeRentPrice(String property_type, Integer bedrooms, Integer price_count, Integer price_mean,
            Integer price_low, Integer price_median, Integer price_high, String currency, String period, String source,
            String published, String recorded_from, String recorded_to, String postcode) {
    ...
    public TargetPostcodeRentPrice() {
    }
    ...
    public String toString() {
        return "TargetPostcodeRentPrice [bedrooms=" + bedrooms + ", currency=" + currency + ", period=" + period
                + ", postcode=" + postcode + ", price_count="
