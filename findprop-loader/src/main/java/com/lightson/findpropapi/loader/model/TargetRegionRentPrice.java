...
public class TargetRegionRentPrice {
    ...
    public TargetRegionRentPrice(String property_type, Integer bedrooms, Integer price_count, Integer price_mean,
            Integer price_low, Integer price_median, Integer price_high, String currency, String period, String source,
            String published, String recorded_from, String recorded_to, String region) {
    ...
    public String toString() {
        return "TargetRegionRentPrice [bedrooms=" + bedrooms + ", currency=" + currency + ", period=" + period
