...
public class SourceLocalAuthorityRentPrice {
    ...
    public SourceLocalAuthorityRentPrice(String localAuthority, String bedroomCategory, Integer countOfRents,
            Integer mean, Integer lowerQuartile, Integer median, Integer upperQuartile, String currency, String period,
            String source, String published, String recordedFrom, String recordedTo) {
    ...
    public SourceLocalAuthorityRentPrice() {
    }
    ...
    public String toString() {
        return "SourceLocalAuthorityRentPrice [bedroomCategory=" + bedroomCategory + ", countOfRents=" + countOfRents
                + ", currency=" + currency + ", localAuthority=" + localAuthority + ", lowerQuartile=" + lowerQuartile
                + ", mean=" + mean + ", median=" + median + ", period=" + period + ", published=" + published
